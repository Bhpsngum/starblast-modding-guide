...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/h3/dist/index.mjs';
import _RemarkEmoji from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/remark-emoji/index.js';
import { visit } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unist-util-visit/index.js';
import { toString } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/hast-util-to-string/index.js';
import { createWasmOnigEngine } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/engine-oniguruma.mjs';
import { createStorage, prefixStorage } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unstorage/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/defu/dist/defu.mjs';
import { extname } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/scule/dist/index.mjs';
import { unified } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unified/index.js';
import { toString as toString$1 } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/slugify/slugify.js';
import remarkParse from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/remark-parse/index.js';
import remark2rehype from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/rehype-raw/index.js';
import { detab } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/detab/index.js';
import Slugger from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/destr/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/klona/dist/index.mjs';
import { createHooks } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/vue/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/Code/aterbot/starblast-modding-guide/node_modules/@unhead/shared/dist/index.mjs';
...
const _hYJrUNtFHf = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "D:/Code/aterbot/starblast-modding-guide";
...
const _inlineRuntimeConfig = {
  ...
  "pinceau": {
    "studio": true,
    "outputDir": "D:/Code/aterbot/starblast-modding-guide/.nuxt/pinceau/"
  },
  "content": {
    "cacheVersion": 2,
...
const serverAssets = [{"baseName":"server","dir":"D:/Code/aterbot/starblast-modding-guide/server/assets"}];
...
storage$1.mount('pinceau', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Code\\aterbot\\starblast-modding-guide\\.nuxt\\pinceau\\theme","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"D:\\Code\\aterbot\\starblast-modding-guide\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Code\\aterbot\\starblast-modding-guide\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Code\\aterbot\\starblast-modding-guide","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Code\\aterbot\\starblast-modding-guide\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Code\\aterbot\\starblast-modding-guide\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Code\\aterbot\\starblast-modding-guide\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Code\\aterbot\\starblast-modding-guide\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _nU42LTimfn = defineNitroPlugin(async (nitro) => {
...
const _kXaIHkgsG8 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _WEy6NV = eventHandler(async (event) => {
...
const _b5bnsf = defineEventHandler(async (event) => {
...
const _pmDngW = defineEventHandler(async (event) => {
...
const _CtFSZc = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_HNAXDY = () => Promise.resolve().then(function () { return search$1; });
const _lazy_qPBYyb = () => Promise.resolve().then(function () { return opensearch_xml$1; });
const _lazy_duiKKT = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/search', handler: _lazy_HNAXDY, lazy: true, middleware: false, method: undefined },
  { route: '/opensearch.xml', handler: _lazy_qPBYyb, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_duiKKT, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _WEy6NV, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _b5bnsf, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _b5bnsf, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _b5bnsf, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _pmDngW, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _CtFSZc, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _CtFSZc, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _CtFSZc, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_duiKKT, lazy: true, middleware: false, method: undefined }
];
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
function createShikiHighlighter({
  ...
  async function _getShiki() {
    const { createHighlighterCore, addClassToHast, isSpecialLang, isSpecialTheme } = await import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/core.mjs');
    const { transformerNotationDiff, transformerNotationErrorLevel, transformerNotationFocus, transformerNotationHighlight } = await import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/@shikijs/transformers/dist/index.mjs');
...
const bundledLangs = {
"javascript": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/javascript.mjs'),
"js": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/javascript.mjs'),
"jsx": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/jsx.mjs'),
"json": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/json.mjs'),
"typescript": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/typescript.mjs'),
"ts": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/typescript.mjs'),
"tsx": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/tsx.mjs'),
"vue": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/vue.mjs'),
"css": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/css.mjs'),
"html": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/html.mjs'),
"shellscript": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/shellscript.mjs'),
"bash": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/shellscript.mjs'),
"sh": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/shellscript.mjs'),
"shell": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/shellscript.mjs'),
"zsh": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/shellscript.mjs'),
"markdown": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/markdown.mjs'),
"md": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/markdown.mjs'),
"mdc": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/mdc.mjs'),
"yaml": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/yaml.mjs'),
"yml": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/yaml.mjs'),
"diff": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/diff.mjs'),
"ini": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/ini.mjs'),
"properties": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/langs/ini.mjs'),
};
const bundledThemes = {
"github-dark": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/themes/github-dark.mjs').then(r => r.default),
"github-light": () => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/themes/github-light.mjs').then(r => r.default),
};
const options = {"theme":{"dark":"github-dark","default":"github-light"}};
const engine = createWasmOnigEngine(() => import('file://D:/Code/aterbot/starblast-modding-guide/node_modules/shiki/dist/wasm.mjs'));
...
const search = defineEventHandler(async (event) => {
  ...
  ((_b = (_a = appConfig == null ? undefined : appConfig.docus) == null ? undefined : _a.search) == null ? undefined : _b.mode) || "meta";
  let docs = await serverQueryContent(event).find();
  docs = await Promise.all(
    docs.filter(
      (doc) => {
        return (doc == null ? undefined : doc._extension) === "md" && (doc == null ? undefined : doc._draft) === false && !(doc == null ? undefined : doc._empty);
      }
    ).map(
      async ({ _id: id, _path: path, _dir: dir, title = "", description = "", body = undefined, ...rest }) => {
        ...
        return {
          ...
          title,
          description,
          keywords: (_a2 = body == null ? undefined : body.toc) == null ? undefined : _a2.links.map((link) => link == null ? undefined : link.text),
...
const opensearch_xml = defineEventHandler(async () => {
  ...
  return '<?xml version="1.0"?>\n<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">\n  <ShortName>' + ((_a = config == null ? undefined : config.docus) == null ? undefined : _a.title) + "</ShortName>\n  <Description>" + ((_b = config == null ? undefined : config.docus) == null ? undefined : _b.description) + '</Description>\n  <Image width="16" height="16" type="image/x-icon">' + ((_c = config == null ? undefined : config.docus) == null ? undefined : _c.url) + '/favicon.ico</Image>\n  <Url type="text/html" template="' + ((_d = config == null ? undefined : config.docus) == null ? undefined : _d.url) + '">\n    <Param name="q" value="{searchTerms}"/>\n  </Url>\n</OpenSearchDescription>';
});
...
const getClientManifest = () => import('file://D:/Code/aterbot/starblast-modding-guide/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Code/aterbot/starblast-modding-guide/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
